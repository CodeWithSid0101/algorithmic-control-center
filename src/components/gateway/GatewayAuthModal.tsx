        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                className="rounded-full p-1 text-zinc-500 hover:bg-white/10 hover:text-zinc-200"
                onClick={onClose}
              >
                <X className="h-4 w-4" />
              </button>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-zinc-400">User Principal (sub)</label>
                <input
                  value={user}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-zinc-400">Role (RBAC)</label>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          role === r.id
                            ...
                            : "border-white/10 bg-white/5 text-zinc-300 hover:border-cyan-400/60 hover:text-cyan-100"
                        )}
                      >
                        {r.label}
                      </button>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-zinc-400">Region (Geo)</label>
                  <div className="flex flex-wrap gap-1.5">
                    {regions.map((r) => (
                      <button
                        key={r.id}
                        ...
                        className={cn(
                          ...
                          region === r.id
                            ...
                            : "border-white/10 bg-white/5 text-zinc-300 hover:border-emerald-400/60 hover:text-emerald-100"
                        )}
                      >
                        {r.label}
                      </button>
